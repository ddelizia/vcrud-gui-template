<nav>
    <ul class="list-unstyled">
        <li class="nav-header"><a href="#" data-toggle="collapse" data-target="#userMenu">
                <h5><i class="glyphicon glyphicon-folder-open"></i> Settings</h5>
            </a>
        ...
        <li class="nav-header"><a href="#" data-toggle="collapse" data-target="#menu2">
                <h5><i class="glyphicon glyphicon-folder-close"></i> Reports</h5>
            </a>
            ...
            <ul class="list-unstyled collapse" id="menu2">
                ...
                <li class="nav-header"><a href="#" data-toggle="collapse" data-target="#menu4">
                    ...
                    <ul class="list-unstyled collapse" id="menu4">
                        <li class="nav-link"><a href="#">Information &amp; Stats</a>
                        </li>
                        <li class="nav-link"><a href="#">Views</a>
                        </li>
                        <li class="nav-link"><a href="#">Requests</a>
                        </li>
                        <li><a href="#">Timetable</a>
                        </li>
                        <li><a href="#">Alerts</a>
        ...
        <li class="nav-header">
            <a href="#" data-toggle="collapse" data-target="#menu3">
                <h5><i class="glyphicon glyphicon-folder-close"></i> Social Media</h5>
            </a>
